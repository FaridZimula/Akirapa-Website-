...
const contactInfo = [
  ...
  },
  {
    icon: Phone,
    title: "Call Us",
    details: ["0745878827 / 0770704041"],
  },
  {
    icon: Mail,
    title: "Email Us",
    details: ["Suyel.ac.ug@gmail.com"],
  },
  {
    icon: Clock,
    title: "Working Hours",
            ...
            <div data-aos="fade-right" className="lg:col-span-7">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-primary rounded-2xl p-8 text-center card-elevated border border-white/10 shadow-lg">
                  ...
                  <div className="space-y-1">
                    <p className="text-white/90 text-base">0745878827</p>
                    <p className="text-white/90 text-base">0770704041</p>
                  </div>
                </div>
                ...
                <div className="md:col-span-2 bg-primary rounded-2xl p-8 text-center card-elevated border border-white/10 shadow-lg">
                  ...
                  <div className="space-y-1">
                    <p className="text-white/90 text-base">Suyel.ac.ug@gmail.com</p>
              ...
              <div className="bg-primary rounded-2xl p-8 shadow-xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <Button
                    ...
                    className="w-full bg-blue-500 hover:bg-blue-600 text-white py-6 text-lg font-bold shadow-lg mt-2 border border-white/10"
                  >
                    {isSubmitting ? (
              ...
              {[
                {
                  ...
                  a: "We welcome volunteers for various programs. Fill out the contact form above or email us at Suyel.ac.ug@gmail.com to learn about current opportunities.",
                },
                {
