...
const Careers = () => {
  ...
  return (
    <Layout>
      <SEO
        title="Careers & Caregiver Opportunities | Akirapa Home Care Bedford MA"
        description="Search current caregiver job listings at Akirapa Home Care. Apply online for CNA, HHA, LPN, RN, and 24/7 live-in care positions in Bedford MA."
      />
