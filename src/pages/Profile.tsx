              ...
              <div data-aos="zoom-in" data-aos-delay="0" className="bg-primary rounded-2xl p-6 card-elevated h-fit flex items-start gap-4 text-left">
                ...
                <div>
                  ...
                  <p className="text-lg text-white/90">
                    We envision a generation of bold resilient and purpose driven youths that will transform Uganda and other parts of the world with creativity, innovation and leadership.
                  </p>
                </div>
              </div>
              <div data-aos="zoom-in" data-aos-delay="100" className="bg-primary rounded-2xl p-6 card-elevated sm:mt-8 h-fit flex items-start gap-4 text-left">
                <Heart className="w-10 h-10 text-white shrink-0" />
                <div>
                  <h3 className="font-semibold text-white mb-2">Values</h3>
                  <p className="text-lg text-white/90">
                    Integrity, empowerment, inclusion, and sustainable impact.
                  </p>
                </div>
              </div>
              <div data-aos="zoom-in" data-aos-delay="200" className="bg-primary rounded-2xl p-6 card-elevated h-fit flex items-start gap-4 text-left">
                <Users className="w-10 h-10 text-white shrink-0" />
                <div>
                  <h3 className="font-semibold text-white mb-2">Community</h3>
                  <p className="text-lg text-white/90">
                    Building networks of support across communities.
                  </p>
                </div>
              </div>
              <div data-aos="zoom-in" data-aos-delay="300" className="bg-primary rounded-2xl p-6 card-elevated sm:mt-8 h-fit flex items-start gap-4 text-left">
                <Globe className="w-10 h-10 text-white shrink-0" />
                <div>
                  <h3 className="font-semibold text-white mb-2">Impact</h3>
                  <p className="text-lg text-white/90">
                    Creating measurable change that lasts for generations.
                  </p>
                </div>
              </div>
            </div>
