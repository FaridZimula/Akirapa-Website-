  ...
  return (
    <Layout>
      ...
      <section className="hero-gradient section-padding relative overflow-hidden">
        ...
        <div className="container-narrow mx-auto text-center relative z-10">
          ...
          <p className="text-lg text-primary-foreground/80 max-w-2xl mx-auto">
            Discover the initiatives transforming lives and creating opportunities for young people.
          </p>
        </div>
      </section>
        ...
        <div className="container-narrow mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground text-lg">
              Our flagship programs making the biggest impact in youth empowerment.
            </p>
          </div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-6 bg-background">
        <div className="relative bg-primary rounded-[2.5rem] py-16 text-center shadow-2xl overflow-hidden">
          {/* Background Image */}
          <div className="absolute inset-0 opacity-[0.15]">
            <img src="/Our profile.jpg" alt="SUYEL community members gathered for a profile event" className="w-full h-full object-cover" />
          </div>
          ...
          <div className="container-narrow mx-auto relative z-10 px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" variant="destructive" className="bg-white text-primary hover:bg-white/90" asChild>
                <Link to="/contact">
                  Become a Partner
