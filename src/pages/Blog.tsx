...
const Blog = () => {
  ...
  useEffect(() => {
    ...
    const triggerVibration = () => {
      ...
      }, 1000); // 1 second high-speed vibration
    };
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <i className="fa-solid fa-layer-group text-[#f0abfc] text-base"></i>
            <div>
          ...
          <div className="rounded-lg p-1.5 bg-purple-950/40 hover:bg-purple-900/60 border border-purple-300/20 transition-transform duration-300">
            <i className={`fa-solid fa-chevron-down text-xs transition-transform duration-300 ${isTopicsOpen ? "rotate-180 text-[#f0abfc]" : "rotate-0 text-white"}`}></i>
          </div>
        </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2.5">
                    <i className={`fa-solid ${topic.icon} w-4 text-center ${isSelected ? "text-[#f0abfc]" : "text-[#76248a]"}`}></i>
                    <span>{topic.label}</span>
                  </div>
                  <span className={`text-[10px] font-extrabold px-2 py-0.5 rounded-full ${
                    isSelected ? "bg-fuchsia-200 text-purple-950 font-black shadow-sm" : "bg-purple-100/80 text-purple-900"
                  }`}>
                    {count}
                  </span>
                </button>
